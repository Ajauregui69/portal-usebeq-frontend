              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="tel" id="u_tel" name="u_tel" value={formData.u_tel} onChange={handleChange} placeholder="4421234567" inputMode="numeric" maxLength={10} className={inputWithIconClass} />
                  </div>
                </div>
                <div>
