...
export default function LandingPage() {
  ...
  const servicios = [
    ...
    { to: '/becas',                  title: 'Becas',                     desc: 'Información sobre becas disponibles',                      color: 'from-amber-500 to-amber-600',  icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z' },
  ...
  const tramites = [
    ...
    { to: '/revocacion-grado',      title: 'Revocación de Grado',       desc: 'Solicita repetición de grado escolar',                     color: 'from-purple-500 to-purple-600', icon: 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' },
