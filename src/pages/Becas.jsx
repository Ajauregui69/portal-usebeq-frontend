      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-600 text-lg">
            Informacion sobre becas disponibles para educacion basica
          </p>
        </div>
          ...
          <div className="p-8">
            <div className="aspect-video w-full max-w-2xl mx-auto rounded-xl overflow-hidden shadow-lg">
              <iframe
                ...
                title="Becas para el Bienestar Benito Juarez"
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8">
          <h2 className="text-2xl font-bold text-slate-800 mb-4">
            Material de Difusion Oficial
          </h2>
          <p className="text-slate-600 mb-8">
            Para conocer mas material de difusion oficial referente a Becas para el Bienestar Benito Juarez
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <div>
                <h3 className="font-bold text-slate-800">Pagina Oficial</h3>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 hover:shadow-md transition-all group"
            >
