    ...
    docs: [
      {
        ...
        badge: 'bg-[#7CC6D8]/20 text-[#242B57]',
      },
      {
      ...
      },
      {
        ...
        categoria: 'Anexos',
        color: 'from-[#707F8F] to-[#242B57]',
        badge: 'bg-[#707F8F]/15 text-[#242B57]',
      },
    ],
  },
  {
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-10">
          <button
            ...
            className="flex items-center gap-2 text-slate-600 hover:text-[#4996C6] mb-4 transition-colors"
          >
          ...
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2 bg-[#242B57] rounded-xl shadow">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
            </div>
            <h1 className="text-3xl font-bold text-[#242B57]">
        ...
        {DOCUMENTOS.map((seccion) => (
          <div key={seccion.seccion} className="mb-10">
            <h2 className="text-lg font-bold text-slate-700 uppercase tracking-wide mb-5 flex items-center gap-2">
              <span className="w-1 h-5 bg-[#242B57] rounded-full inline-block"></span>
              {seccion.seccion}
            </h2>
